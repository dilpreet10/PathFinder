...
export default class PathfindingVisualizer extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="icons">
            <a href="https://github.com/dilpreet10" target="_blank" rel="noopener noreferrer">
      ...
      <div className="grid">
      <button id = "dijkstra" className="dijkstra" onClick={() => this.visualizeDijkstra()}>
            Visualize Dijkstra's Algorithm
        </button>
        <button id = "dfs" className="dfs" onClick={() => this.visualizeDFS()}>
            Visualize Depth First Search 
        </button>
        <button id = "bfs" className="bfs" onClick={() => this.visualizeBFS()}>
            Visualize Breadth First Search
        </button>
      <button id = "clearColors" className="clearColors" onClick={() => this.clearColors()}>
            Clear Colors
        </button>
      <button id = "clearBoard" className="clearBoard" onClick={() => this.clearBoard()}>
            Clear Board
      </button>
        {grid.map((row, rowIdx) => {
          return (
